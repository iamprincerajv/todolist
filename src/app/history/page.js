...
const History = () => {
  ...
  return (
    <main className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-5 place-items-center'>
      ...
      <div onClick={deleteHisto} className='hidden sm:block absolute top-1 right-4 bg-white py-2 px-3 rounded-md cursor-pointer'>
        <Image src={deleteImg} alt='Delete' width={16} />
      </div>
